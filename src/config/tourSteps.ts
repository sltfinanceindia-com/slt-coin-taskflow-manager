...
const employeeSteps: TourStep[] = [
  ...
  {
    target: '[data-tab-url="okrs"]',
    content: 'Set and track your personal goals and OKRs. Monitor your progress and align with team objectives.',
    title: 'My Goals & OKRs',
    placement: 'right',
    disableBeacon: true,
    roles: ['employee', 'intern'],
...
const managerSteps: TourStep[] = [
  ...
  {
    target: '[data-tab-url="tasks"]',
    content: 'Create and assign tasks to your team. Use the Kanban board to manage workflows and track progress.',
    title: 'Task Creation & Management',
    placement: 'right',
    disableBeacon: true,
    roles: ['manager', 'team_lead', 'project_manager', 'hr_admin'],
  },
  {
  ...
  {
    target: '[data-tab-url="communication"]',
    content: 'Communicate with your team through messaging, announcements, and collaboration channels.',
...
const adminSteps: TourStep[] = [
  ...
  {
    target: '[data-tab-url="tasks"]',
    content: 'Create and assign tasks across teams. Use the Kanban board for visual task management and workflow tracking.',
    title: 'Task Creation & Management',
    placement: 'right',
    disableBeacon: true,
    roles: ['admin', 'org_admin', 'super_admin'],
  ...
  {
    target: '[data-tab-url="approvals"]',
    content: 'Review and manage pending approvals for leave, expenses, and other organizational requests.',
    title: 'Approvals',
    placement: 'right',
    disableBeacon: true,
    roles: ['admin', 'org_admin', 'super_admin'],
...
const financeSteps: TourStep[] = [
  {
    target: '[data-tab-url="payroll"]',
    content: 'Process payroll, manage salary structures, and handle bonus disbursements for the organization.',
  ...
  {
    target: '[data-tab-url="expenses"]',
    content: 'Review and approve employee expense claims, manage reimbursements, and track spending.',
  ...
  {
    target: '[data-tab-url="budget-planning"]',
    content: 'Plan departmental budgets, manage cost centers, and track budget utilization.',
  ...
  {
    target: '[data-tab-url="approvals"]',
    content: 'Review and approve financial requests including expenses, loans, and reimbursements.',
  ...
  {
    target: '[data-tab-url="reports"]',
    content: 'Access financial reports, cost center analysis, and budget tracking dashboards.',
  ...
  {
    target: '[data-tab-url="communication"]',
    content: 'Coordinate with teams on payroll updates, policy changes, and financial announcements.',
    title: 'Communication',
    placement: 'right',
    disableBeacon: true,
    roles: ['finance_manager'],

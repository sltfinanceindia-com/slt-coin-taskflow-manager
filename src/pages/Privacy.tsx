              ...
              <CardContent className="p-6 sm:p-8 prose prose-sm sm:prose-base dark:prose-invert max-w-none">
                <section className="mb-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tenexa ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy 
                ...
                <section className="mb-8">
                  ...
                  <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
                    ...
                    <li>Coin earnings and transactions</li>
                  </ul>
                ...
                <section className="mb-8">
                  ...
                  <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                    ...
                    <li>To administer the coin reward system</li>
                ...
                <section>
                  ...
                  <div className="mt-4 p-4 bg-muted rounded-lg">
                    <p className="text-foreground font-medium">Tenexa Data Protection Team</p>
                    <p className="text-muted-foreground">Email: privacy@tenexa.com</p>
                    <p className="text-muted-foreground mt-2">
                      For GDPR-related inquiries, you may also contact our Data Protection Officer at dpo@tenexa.com
                    </p>
                  </div>
                </section>
              </CardContent>

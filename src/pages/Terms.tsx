...
import { ArrowLeft, Coins, FileText } from 'lucide-react';
            ...
            <CardContent className="p-6 sm:p-8 prose prose-sm sm:prose-base dark:prose-invert max-w-none">
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  By accessing and using SLT work HuB ("the Platform"), you accept and agree to be bound by these Terms of Service. 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  SLT work HuB is a comprehensive workplace management platform that provides:
                </p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                  ...
                  <li>SLT Coin reward system for productivity incentives</li>
              ...
              <section className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">5. SLT Coin System</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  The SLT Coin reward system is subject to the following terms:
                </p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  All content, features, and functionality of the Platform are owned by SLT work HuB and are protected 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  regulations including GDPR and Indian data protection laws.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To the maximum extent permitted by law, SLT work HuB shall not be liable for any indirect, incidental, 
              ...
              <section className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">10. Changes to Terms</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">11. Governing Law</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section>
                <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">12. Contact Information</h2>
                <p className="text-muted-foreground leading-relaxed">
                  If you have any questions about these Terms of Service, please contact us at:
                </p>
                <div className="mt-4 p-4 bg-muted rounded-lg">
                  <p className="text-foreground font-medium">SLT work HuB Support</p>
                  <p className="text-muted-foreground">Email: support@sltworkhub.com</p>

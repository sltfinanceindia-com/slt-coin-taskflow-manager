            ...
            return (
              ...
              >
                <Link to="/features" className="block h-full">
                  <motion.div
                    className={`group relative h-full p-6 rounded-2xl bg-background border border-border/50 overflow-hidden transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5 cursor-pointer ${
                  ...
                  >
                    ...
                    {isLarge && (
                      <span className="inline-flex items-center gap-2 mt-4 text-sm font-medium text-primary group-hover:text-primary/80 transition-colors">
                        Learn more

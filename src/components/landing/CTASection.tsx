    ...
    <section className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Join 500+ organizations using TeneXA to streamline HR, projects, and operations. 
            ...
            >
              <Link to="/contact">
                <Button 
                  size="lg" 
                  variant="outline"
                  className="w-full sm:w-auto h-14 px-10 text-lg bg-transparent border-2 border-white/30 text-white hover:bg-white/10 hover:border-white/50"
                >
